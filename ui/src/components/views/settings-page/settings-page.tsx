...
import { Panel, Text, Title, View } from '@vkontakte/vkui'
    ...
    <View activePanel='settings'>
      <Panel className={styles.settingsPageWrapper} id='settings'>
        <section className={styles.settingsHero}>
          <Text className={styles.settingsLabel}>{t('System Controls')}</Text>
          <Title className={styles.settingsTitle} level='2'>
