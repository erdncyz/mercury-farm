...
import {BrowserClearMessage, BrowserOpenMessage} from '../../../wire/wire.js'
...
export default syrup.serial()
    ...
    .define(function(options, router, push, adb, service) {
        ...
        router.on(BrowserOpenMessage, function(channel, message) {
        ...
        router.on(BrowserClearMessage, function(channel, message) {
