...
export default syrup.serial()
    ...
    const plugin = {
        ...
        start: () => new Promise((resolve, reject) => {
            ...
            // TODO: fix
            const auth = (key) => new Promise(async (resolve, reject) => {
        ...
        stop: async () => {
            ...
            const waitServerClose = new Promise((resolve) => {
    ...
    group.on('join', (group, keys) => plugin.auth = key => {
    ...
    group.on('autojoin', (id, joined) => plugin.auth = key => {
