 ...
 */
function proxyRequest(targetUrl, headers, res, timeout) {
...
export default function (options) {
    ...
    route.get('/s/apk/:id/:name', (req, res) => {
        const targetUrl = url.resolve(options.storageUrl, util.format('/s/blob/%s/%s', req.params.id, req.params.name));
