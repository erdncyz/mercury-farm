...
export default syrup.serial()
    ...
    .define(async(options, solo, router, push, sub, channels) => {
        ...
        plugin.isAutomation = () => currentUsage === 'automation'
        ...
        plugin.join = (newGroup, timeout, usage) => {
            return plugin.get()
                .then(() => {
                    ...
                    dbapi.enhanceStatusChangedAt(options.serial, newTimeout, 'session').then(() => {
                        return currentGroup
                    })
                })
                .catch(grouputil.NoGroupError, () => {
                    ...
                    dbapi.enhanceStatusChangedAt(options.serial, timeout, 'session')
