                ...
                AllModel.getInstalledApplications({serial: message.serial})
                    .then(applications => {
                        ...
                        if (message?.owner?.email === user?.email) {
                            user.ownedChannels.add(applications.channel)
                            sendAndroidRuntimeSettingsToChannel(applications.channel, user?.settings?.androidRuntimeSettings)
                            sendIosRuntimeSettingsToChannel(applications.channel, user?.settings?.iosRuntimeSettings)
                        }
                        else if (user.ownedChannels.has(applications.channel)) {
                            user.ownedChannels.delete(applications.channel)
                        }
