...
const getAddedAttributes = (fn, args) => Object.fromEntries(getArgumentsNames(fn).map((argument, i) => [
    `dbapi.${argument}`,
    args[i]
]));
export default (model) => Object.keys(model).reduce((proxiedModel, method) => {
