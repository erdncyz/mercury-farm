...
import {GroupChangeMessage, GroupField, LeaveGroupMessage, UngroupMessage} from '../../../wire/wire.js'
            ...
            const devices = await Promise.all(group.devices?.map(
                serial => new Promise(async(resolve) => {
                    ...
                    const listener = new WireRouter()
                        .on(LeaveGroupMessage, (channel, message) => {
