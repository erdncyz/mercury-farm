...
export const handler = function(argv) {
    ...
    return device({
        ...
        // WebRTC runs inside the provider container, so its automatically
        // discovered Docker address is not reachable by LAN browsers. Unless
        // explicitly overridden (for example by a public NAT address),
        // advertise the same address that the provider uses for screen URLs.
        screenWebrtcPublicIp: argv.screenWebrtcPublicIp || argv.publicIp,
