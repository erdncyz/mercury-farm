...
export const builder = function(yargs) {
    return yargs
        ...
        .option('ks-dname', {
            ...
            type: 'string',
            default: 'CN=mercury.io, OU=mercury, O=mercury, L=PaloAlto, S=California, C=US'
        })
        .option('secret', {
            alias: 's',
        ...
        'underscores and prefixing it with `MERCURY_STORAGE_TEMP_` (e.g. ' +
        '`MERCURY_STORAGE_TEMP_SAVE_DIR`).')
}
