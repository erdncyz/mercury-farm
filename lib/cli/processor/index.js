...
export const builder = function(yargs) {
    return yargs
        ...
        .option('public-ip', {
            alias: 'pi',
            description: 'Defined public ip for Mercury',
            type: 'string',
            default: 'localhost'
        })
        .epilog('Each option can be be overwritten with an environment variable ' +
        'by converting the option to uppercase, replacing dashes with ' +
        'underscores and prefixing it with `MERCURY_PROCESSOR_` (e.g. ' +
        '`MERCURY_PROCESSOR_CONNECT_APP_DEALER`).')
}
