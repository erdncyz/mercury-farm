import openid from '../../units/auth/openid.js'
export const command = 'auth-openid'
export const describe = 'Start an OpenID auth unit.'
export const builder = function(yargs) {
    return yargs
        .env('MERCURY_AUTH_OPENID')
        .strict()
        .option('app-url', {
            alias: 'a',
        ...
        .option('scopes', {
            describe: 'Scopes to request the openid provider',
            type: 'string',
            default: 'user_info'
        })
        .option('port', {
        ...
        'underscores and prefixing it with `MERCURY_AUTH_OPENID_` (e.g. ' +
        '`MERCURY_AUTH_OPENID_SECRET`). Legacy environment variables like ' +
