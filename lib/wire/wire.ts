...
/**
 * @generated from protobuf message FileSystemPushMessage
 */
export interface FileSystemPushMessage {
    /**
     * @generated from protobuf field: required string href = 1
     */
    href: string;
    /**
     * @generated from protobuf field: required string filename = 2
     */
    filename: string;
    /**
     * @generated from protobuf field: required string mediaType = 3
     */
    mediaType: string;
    /**
     * @generated from protobuf field: optional string jwt = 4
     */
    jwt?: string;
}
/**
...
/**
 * @generated from protobuf message ApplyIosRuntimeSettingsMessage
 */
export interface ApplyIosRuntimeSettingsMessage {
    /**
     * @generated from protobuf field: required uint32 touchWatchdogTimeoutMs = 1
     */
    touchWatchdogTimeoutMs: number;
    /**
     * @generated from protobuf field: required uint32 wdaRequestTimeoutMs = 2
     */
    wdaRequestTimeoutMs: number;
    /**
     * @generated from protobuf field: required uint32 wdaSessionTimeoutMs = 3
     */
    wdaSessionTimeoutMs: number;
    /**
     * @generated from protobuf field: required uint32 actionTimeoutRecoveryThreshold = 4
     */
    actionTimeoutRecoveryThreshold: number;
    /**
     * @generated from protobuf field: required uint32 touchRecoveryCooldownMs = 5
     */
    touchRecoveryCooldownMs: number;
    /**
     * @generated from protobuf field: required bool wdaLeanMode = 6
     */
    wdaLeanMode: boolean;
    /**
     * @generated from protobuf field: required uint32 wdaMjpegQuality = 7
     */
    wdaMjpegQuality: number;
    /**
     * @generated from protobuf field: required uint32 wdaMjpegScaling = 8
     */
    wdaMjpegScaling: number;
    /**
     * @generated from protobuf field: required uint32 wdaTreeCacheMs = 9
     */
...
// @generated message type with reflection information, may provide speed optimized methods
class FileSystemPushMessage$Type extends MessageType<FileSystemPushMessage> {
    constructor() {
    ...
    create(value?: PartialMessage<FileSystemPushMessage>): FileSystemPushMessage {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.href = "";
        message.filename = "";
        message.mediaType = "";
        if (value !== undefined)
            reflectionMergePartial<FileSystemPushMessage>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FileSystemPushMessage): FileSystemPushMessage {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: FileSystemPushMessage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
// @generated message type with reflection information, may provide speed optimized methods
class ApplyIosRuntimeSettingsMessage$Type extends MessageType<ApplyIosRuntimeSettingsMessage> {
    constructor() {
    ...
    create(value?: PartialMessage<ApplyIosRuntimeSettingsMessage>): ApplyIosRuntimeSettingsMessage {
        ...
        if (value !== undefined)
            reflectionMergePartial<ApplyIosRuntimeSettingsMessage>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ApplyIosRuntimeSettingsMessage): ApplyIosRuntimeSettingsMessage {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ApplyIosRuntimeSettingsMessage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
